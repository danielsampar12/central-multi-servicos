...
export function MainFooter() {
  return (
    <div className="MainFooterContainer reg:px-[6.5rem] px-10 py-11">
      ...
      <div className="InfoContainer w-full flex flex-row justify-between">
        <div className="TextInfoContaniner flex flex-col items-start">
          <h1 className="InfoName text-white reg:text-2xl text-xl font-inter font-semibold tracking-[0.03125rem] reg:mb-10 mb-3">
            Informações da empresa
          </h1>
          <span className="InfoItem text-white reg:text-lg text-base font-medium font-inter tracking-[0.03125rem] mb-2">
        ...
        <div className="TextInfoContaniner1 flex flex-col items-start">
          ...
          <a
            href="#section1"
            className="InfoItem text-white reg:text-lg text-base font-medium font-inter tracking-[0.03125rem] mb-2"
          >
            Início
          </a>
          <a
          ...
          <a className="#section4 text-white reg:text-lg text-base font-medium font-inter tracking-[0.03125rem] mb-2">
            Sobre nós
          </a>
          <a
            href="#footer"
